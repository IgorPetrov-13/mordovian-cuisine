...
export const Logo = () => {
  return (
    <Link href="/" title="Mordovian cuisine" className="flex ">
      ...
      <p className="font-bold text-black">MC</p>
    </Link>
  );
};
  ...
  return (
    <Navbar className={`h-[${layoutConfig.headerHeight}]`}>
      ...
      <NavbarContent justify="end">
        ...
        <NavbarItem>
          <Button as={Link} color="primary" href="#" variant="flat" onPress={() => setIsRegModalOpen(true)}>
            Регистрация
          </Button>
        </NavbarItem>
